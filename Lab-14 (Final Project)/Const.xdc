...
# ==== Add to permit gate-level loops (e.g. S-R FlipFlop)
...
# On-board 7-Segment display 0 [LEFT group of 4 digits] control
# On-board 7-Segment display 0 Anode-enable signals (active Low):
...
# On-board 7-Segment display 0 Segment-enable signals (active Low):
...
# On-board 7-Segment display 1 [RIGHT group of 4 digits] control
# On-board 7-Segment display 1 Anode-enable signals (active Low):
...
# On-board 7-Segment display 1 Segment-enable signals (active Low):
...
# Pmod Connectors (GPIO Only):	3 2 1  <-- Connector center (single-ended I/Os)
#                               4 5 6
set_property -dict {PACKAGE_PIN C18 IOSTANDARD LVCMOS33} [get_ports {J1[0]}]
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports {J1[1]}]
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33} [get_ports {J1[2]}]
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports {J1[3]}]
set_property -dict {PACKAGE_PIN F18 IOSTANDARD LVCMOS33} [get_ports {J1[4]}]
set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS33} [get_ports {J1[5]}]
set_property -dict {PACKAGE_PIN M5  IOSTANDARD LVCMOS33} [get_ports {J2[0]}]
set_property -dict {PACKAGE_PIN L6  IOSTANDARD LVCMOS33} [get_ports {J2[1]}]
set_property -dict {PACKAGE_PIN K6  IOSTANDARD LVCMOS33} [get_ports {J2[2]}]
set_property -dict {PACKAGE_PIN M3  IOSTANDARD LVCMOS33} [get_ports {J2[3]}]
set_property -dict {PACKAGE_PIN K3  IOSTANDARD LVCMOS33} [get_ports {J2[4]}]
set_property -dict {PACKAGE_PIN J6  IOSTANDARD LVCMOS33} [get_ports {J2[5]}]
