...
module text_display(
    ...
    always @(posedge clk) begin
        ...
        if (count2 == 100000) begin
            ...
            if (inc[15:12] == 4'b1010) inc[15:12] = 4'b0000;
            count2 = 0;
        end

        if (count3 == 1000000) begin
            inc[11:8] = inc[11:8] + 4'b0001;
            if (inc[11:8] == 4'b1010) inc[11:8] = 4'b0000;
            count3 = 0;
        end

        if (count4 == 10000000) begin
            inc[7:4] = inc[7:4] + 4'b0001;
            if (inc[7:4] == 4'b1010) inc[7:4] = 4'b0000;
            count4 = 0;
        end

        if (count5 == 100000000) begin
            inc[3:0] = inc[3:0] + 1;
            if (inc[3:0] == 4'b1010) inc[3:0] = 0;
            count5 = 0;
        end
